...
def _normalize_result(filename: str, data: dict) -> NormalizedBenchmarkResult:
    ...
    if is_new_format:
        ...
        return NormalizedBenchmarkResult(
            ...
            avg_doc_precision_at_k=_stringify_keys(eval_data.get("avg_doc_precision_at_k", {})) or None,
            avg_doc_recall_at_k=_stringify_keys(eval_data.get("avg_doc_recall_at_k", {})) or None,
            avg_doc_mrr=eval_data.get("avg_doc_mrr"),
            avg_chunk_precision_at_k=_stringify_keys(eval_data.get("avg_chunk_precision_at_k", {})) or None,
        ...
        return NormalizedBenchmarkResult(
            ...
            avg_doc_precision_at_k=_stringify_keys(data.get("avg_doc_precision_at_k", {})) or None,
            avg_doc_recall_at_k=_stringify_keys(data.get("avg_doc_recall_at_k", {})) or None,
            avg_doc_mrr=data.get("avg_doc_mrr"),
            avg_chunk_precision_at_k=_stringify_keys(data.get("avg_chunk_precision_at_k", {})) or None,
