#!/usr/bin/env python3
"""
Run Phase 1 baseline evaluation on 35-question test set.

This script:
1. Indexes articles into in-memory Qdrant
2. Loads the 35 evaluation questions
3. Runs comprehensive evaluation
4. Saves results for Phase 2 comparison
"""
...
def main():
    print("=" * 70)
    print("Phase 1 Baseline Evaluation - 35 Questions")
    print("=" * 70)
    print()

    collection_name = "ww2_historical_events"
    questions_file = settings.DATA_DIR / "evaluation" / "eval_50_questions.json"
    results_file = project_root / "results" / "phase1_baseline_35q.json"
    ...
    print()
    print("Next Step:")
    print("  Implement Phase 2 (Hybrid + Temporal RAG) to improve performance")
    print()
